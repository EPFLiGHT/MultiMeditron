...
class MOEModalityWithProjectionConfig(ModalityConfig):
    model_type = "moe_proj_meditron_clip"
...
class MOEModalityWithProjection(ModalityWithProjection):
    config_class = MOEModalityWithProjectionConfig

    def __init__(self, config: MOEModalityWithProjectionConfig):
