#!/usr/bin/env python3
"""
African Languages Experiment Using Pre-Translated Dataset (Base NLLB)

Compares translation pipeline vs native multilingual for African languages:
1. Translation pipeline with finetuned NLLB (NLLB → English → Meditron)
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate translation pipeline vs native multilingual for African languages (Base NLLB)"
    )
    parser.add_argument(
        "--input",
